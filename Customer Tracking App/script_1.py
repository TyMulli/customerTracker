# Create a Python tkinter desktop application alternative
tkinter_app_code = '''
    ...
    def init_database(self):
        ...
        cursor.execute('''
            CREATE TABLE IF NOT EXISTS acquisition_data (
                ...
                acquisition_rate REAL CALCULATED,
                cost_per_acquisition REAL CALCULATED
            )
        ''')
...
# Save the tkinter application code
with open('customer_tracker_desktop.py', 'w') as f:
    f.write(tkinter_app_code)

print("Desktop Application Created!")
print("File: customer_tracker_desktop.py")
print("\nTo run the desktop application:")
print("1. Install required packages: pip install matplotlib numpy")
print("2. Run: python customer_tracker_desktop.py")
print("\nFeatures:")
